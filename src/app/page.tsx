...
import { FileCode, Archive, ListChecks, Lightbulb, BookOpen, Users, TerminalSquare } from "lucide-react"; // Added TerminalSquare (or FileCode if preferred for card)
...
export default function HomePage() {
  return (
    <div className="container mx-auto py-8">
      ...
      <section className="grid gap-8 md:grid-cols-2 lg:grid-cols-3 mb-12"> {/* Adjusted grid for 3 items */}
        <FeatureCard
          icon={<TerminalSquare className="w-10 h-10 text-primary" />} // Using TerminalSquare for consistency, or FileCode
